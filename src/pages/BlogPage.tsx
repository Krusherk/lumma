          ...
          <div className="bg-footer-inner">
            ...
            <div className="bg-footer-links">
              ...
              <div className="bg-footer-col">
                ...
                <a href="mailto:support@lumma.xyz" className="bg-footer-social">
                  <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4L12 13 2 4"/></svg>
                  Support
                </a>
              </div>
            </div>
